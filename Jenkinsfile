...
'''
            script {
              ...
              s3Upload acl: 'Private', bucket: 'mutation-analysis', file: 'coverage.json', path: "sanataro/master/${env.BUILD_NUMBER}/", workingDir: "coverage"
            }
...
'''
    ...
    stage('Upload') {
      steps {
        script {
          s3Upload acl: 'Private', bucket: 'mutation-analysis', file: 'rubocop.json', path: "sanataro/master/${env.BUILD_NUMBER}/"
          
          s3Upload acl: 'Private', bucket: 'mutation-analysis', file: 'coverage.json', path: "sanataro/master/${env.BUILD_NUMBER}/mutate_coverage.json", workingDir: "coverage"
          
          s3Upload acl: 'Private', bucket: 'mutation-analysis', file: 'report.json', path: "sanataro/master/${env.BUILD_NUMBER}/", workingDir: "tmp/rubycritic"
          
          s3Upload acl: 'Private', bucket: 'mutation-analysis', file: 'mutate.out', path: "sanataro/master/${env.BUILD_NUMBER}/"
        }
